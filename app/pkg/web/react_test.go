...
func TestReactRenderer_RenderEmptyHomeHTML(t *testing.T) {
	...
	Expect(html).ContainsSubstring(`Help shape our future by sharing your ideas.\n\nVote on suggestions that matter to you, discuss with the community, and let us know what we should improve.`)
